...
import { ThumbsUp, Camera, AlertTriangle, ArrowRight, ArrowBigUp } from "lucide-react";
        ...
        <div className="h-full w-full bg-white flex flex-col border-l border-gray-200 shadow-2xl">
            ...
            <div className="flex border-b bg-gray-50/50">
                <button
                    ...
                    className={`flex-1 p-3 font-semibold text-xs uppercase tracking-wide transition-colors ${
                        activeTab === "view"
                      ...
                      `}
                                        >
                                            ...
                                            <ArrowBigUp
                                                size={14}
                                                className={
                                                    user && ticket.upvotes.includes(user.uid) ? "fill-current" : ""
                                                }
                                            />
                                            {ticket.voteCount || 0}
                                        </button>
